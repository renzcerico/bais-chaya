...
<script type="text/javascript">
	$(function(){
		...
		const getstatus = () => {
			...
			// 	url: '../php/status.php',
			// 	success: (res ) => {
			// 		res != 'verified' ? $('#modal_verification').methododal({ backdrop: 'static', keyboard: false }) : false;
			// 	}
			// });

			status != 'verified' ? $('#modal_verification').modal({ backdrop: 'static', keyboard: false }) : false;
		};
